...
\usepackage[backend=biber, style=numeric, sorting=none, giveninits=true, maxnames=3]{biblatex}
...
\lstdefinestyle{mystyle}{
    ...
    breaklines=true,
    captionpos=b,
    aboveskip=\abovecaptionskip,
	belowskip=\belowcaptionskip,
    keepspaces=true,
    numbers=left,
    numbersep=10pt,
...
\newcommand{\xmark}{\textcolor{firebrick}{\ding{55}}}%
