...
\begin{lstlisting}[language=MyHTML, caption={[HTML element for a download button]\textbf{HTML element for a download button.} This HTML element contains a button that downloads the pdbe-arpeggio protein-ligand contacts for all biological assemblies mapping to a protein segment. The JavaScript \texttt{saveAllAssembliesContactData} is called upon clicking. A combination of Bootstrap classes and custom CSS is used for stylings.}, label={html_button}]
<div
