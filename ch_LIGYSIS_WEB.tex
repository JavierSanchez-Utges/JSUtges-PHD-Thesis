...
Utgés, J.S., MacGowan, S.M., Barton, G.J. LIGYSIS-web: a resource for the analysis of protein-ligand binding sites. (\textit{Manuscript accepted for publication})
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=1.5\textwidth]{figures/ch_LIGYSIS_WEB/PNG/LIGYSIS_WEB_RESULTS_PAGE_P00517_NEW.png}
