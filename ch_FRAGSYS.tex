...
Different loss functions resulted in a substantial loss of accuracy: Δ\textsubscript{\textit{acc}} $\approx$ \textminus50\% (FDR $<$ 0.05). This is expected as they are not appropriate for a multi-label classifier, unlike sparse categorical cross-entropy.
