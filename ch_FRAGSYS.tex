...
\autorefpanel{fig:bs_clusts_feats_2}{A} shows the RSA distribution across the four clusters. C1 presents a strikingly different distribution to the rest of clusters, peaking at RSA $\approx$ 5\%, indicating a high density of buried residues. C2 still presents an excess of buried residues relative to  C3-4, though not as high as C1. C4 presents the most different distribution to C1, peaking at RSA $\approx$ 50-70\%. This definition agrees with \autoref{fig:bss_clust_profiles} and  \autorefpanel{fig:bs_clusts_feats_1}{A}. 
