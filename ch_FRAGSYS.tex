...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/FIG8_bs_def_CROP.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/FIG9_bs_clust.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/ch_FRAGSYS/SUPP_FIG1_ward_clust.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/SUPP_FIG2_KNN_robustness.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/SUPP_FIG3_MLP_ablation.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/FIG10_ml_results.pdf}
...
The main summary result tables resulting from this analysis are available in the following repository: https://github.com/bartongroup/FRAGSYS (DOI: 10.5281/zenodo.10606595) \cite{UTGES_2024_FRAGSYS_ZENODO}.

\subsection{Code availability}

Software developed to carry out this analysis is also found in our GitHub repository: https://github.com/bartongroup/FRAGSYS (DOI: 10.5281/zenodo.10606595).
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/FIG1_bs_examples.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/FIG2_bs_feats.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/FIG3_bs_feats_corr.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ch_FRAGSYS/FIG4_bs_clust_results_OPT4.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/FIG5_bs_clust_feats.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.60\textwidth]{figures/ch_FRAGSYS/FIG6_bs_clust_func_enrichment.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ch_FRAGSYS/FIG7_c1_example_1.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/FIG7_c1_example_2.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/FIG7_c1_example_3.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/ch_FRAGSYS/FIG7_c1_example_4.pdf}
