...
\texttt{N\textsubscript{LAYERS} = 0}                   & 0.83              &  \textminus11.00                     & 0            \\ \hline
\texttt{N\textsubscript{LAYERS} = 2}                    & 0.93              &  \textminus1.00                      & 0            \\ \hline
\texttt{N\textsubscript{LAYERS} = 5}                    & 0.94              &  \textminus0.15                   & 0.42         \\ \hline
\texttt{N\textsubscript{LAYERS} = 10}                   & 0.85              &  \textminus8.93                   & 0            \\ \hline
\texttt{N\textsubscript{NEURONS} = 1}                  & 0.79              &  \textminus14.93                  & 0            \\ \hline
\texttt{N\textsubscript{NEURONS} = 2}                  & 0.9               &  \textminus4.15                   & 0            \\ \hline
\texttt{N\textsubscript{NEURONS} = 3}                  & 0.93              &  \textminus1.06                   & 0            \\ \hline
\texttt{N\textsubscript{NEURONS} = 4}                  & 0.94              &  \textminus0.28                   & 0.24         \\ \hline
\texttt{N\textsubscript{NEURONS} = 5}                  & 0.94              &  \textminus0.13                   & 0.54         \\ \hline
\texttt{N\textsubscript{NEURONS} = 6}                  & 0.94              &  \textminus0.24                   & 0.26         \\ \hline
