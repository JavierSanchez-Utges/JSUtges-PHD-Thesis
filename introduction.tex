...
Drug discovery is the process of developing a new drug and goes from the original idea conception to the market launch of a finished product and even beyond. This is an extremely complex process which can take 12-15 years and cost more than \$1 billion \cite{HUGHES_2011_DRUGS}. This process is also known as the drug discovery (and development) pipeline and is illustrated in \autoref{fig:drug_discovery}.
